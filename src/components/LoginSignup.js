    ...
    <div className="h-screen w-screen flex items-center justify-center bg-gray-100">
      ...
      <div className="w-4/6 opacity-90  max-w-md bg-black absolute border border-black shadow-md rounded-xl p-6">
        <div className="flex justify-center mb-4">
          <button
            className={`text-xl mr-4 focus:outline-none ${current === "login" ? "text-blue-500" : "text-white"
              }`}
          ...
          <button
            className={`text-xl focus:outline-none ${current === "signup" ? "text-blue-500" : "text-white"
              }`}
            onClick={handleCurrent}
            name="signup"
          >
